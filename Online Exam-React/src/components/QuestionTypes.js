...
function Question(props) {
	...
	if (props.cur === -1) {
		return (
			<div className="main">
				<h2 style={{ color: '#1f1f7a' }} >Instructions to follow : </h2>
				<div className="rules">
				<ul>
		            <li>Accept the honour code before taking the exam.</li>
		            <li>We can navigate through the questions using nav bar.</li>
		            <li>Do not try to perform any malpractice.</li>
		            <li>Try to finish your exam within given time.</li>
		        </ul>
				</div><br />
			</div>
		)
		...
		return (
			<div>
				...
				/>
				<Link to="/score">
					<button id="submitbtn">Finish Test</button>
				</Link>
			</div>
		)
	} else {
